...
@section('content')
    <div class="page-content">
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ route('admin.report.period') }}">Period</a></li>
        </ol>
        <div class="page-heading">
            <h1>Report<small>Period</small></h1>
            <div class="options">
            </div>
        </div>
        <div class="container-fluid">
            <div data-widget-group="group1">
                {!! Form::open(['route' =>  'admin.report.result']) !!}
                @if (count($errors) > 0)
                    <div class="row">
                        <div class="col-md-12">
...
<script src="{{ url('assets/backend') }}/plugins/bootstrap-datepicker/bootstrap-datepicker.js"></script>
@endpush
